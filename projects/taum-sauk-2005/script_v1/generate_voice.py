...
script = load_scored_script("projects/taum-sauk-2005/script_v1/scored_script.yaml")
out_dir = Path("projects/taum-sauk-2005/assets/audio_v6")
...
OUTPUT_FORMAT = "mp3_44100_128"   # account below Creator tier (192k gated) - 128k is transparent for spoken word
